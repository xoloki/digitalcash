...
\begin{align}
  ...
  z^2 \cdot \left<\textbf{a}_L, \textbf{2}^n\right> + z \cdot \left<\textbf{a}_L, \textbf{y}^n\right> - z \left<\textbf{a}_R, \textbf{y}^n\right> + \left<\textbf{a}_L,  \textbf{a}_R \circ \textbf{y}^n\right> = z^2 v + z \cdot \left<\textbf{1}^n, \textbf{y}^n\right>
\end{align}
