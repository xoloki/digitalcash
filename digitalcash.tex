...
\begin{eqnarray}
  L = H(\textbf{0}^{n'}, \textbf{a}_{[n':]}, \textbf{b}_{[:n']}, \textbf{0}^{n'}, <\textbf{a}{[n':]}, \textbf{b}{[:n']}>)\\
  R = H(\textbf{a}{[:n']}, \textbf{0}^{n'}, \textbf{0}^{n'}, \textbf{b}{[n':]}, <\textbf{a}{[:n']}, \textbf{b}{[n':]}>)
\end{eqnarray}
...
Verifier then uses (x, \textbf{a}', \textbf{b}') to calculate Q', and and validates if P' = Q': 
\begin{eqnarray}
  Q' = H(x-1 \textbf{a}', x \textbf{a}', x \textbf{b}', x-1 \textbf{b}', <\textbf{a}', \textbf{b}'>)
\end{eqnarray}

This works because if we expand Q':
\begin{eqnarray}
  Q' = H(x-1(x \textbf{a}L + x-1 \textbf{a}R), x(x \textbf{a}L + x-1 \textbf{a}R), x(x-1 \textbf{b}L + x \textbf{b}R), x-1(x-1 \textbf{b}L + x \textbf{b}R), 
  <x \textbf{a}L + x-1 \textbf{a}R, x-1 \textbf{b}L + x \textbf{b}R>)\\
  Q' = H(\textbf{a}L + x-2 \textbf{a}R, x2 \textbf{a}L + \textbf{a}R, \textbf{b}L + x2 \textbf{b}R, x-2 \textbf{b}L + \textbf{b}R, 
  x2<\textbf{a}L , \textbf{b}R> + <\textbf{a}L, \textbf{b}L> + <\textbf{a}R, \textbf{b}R> + x-2 <\textbf{a}R, \textbf{b}L>)
\end{eqnarray}
