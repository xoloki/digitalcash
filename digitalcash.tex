...
Verifier validates if $P' = Q'$.  This works because if we expand $Q'$:
\begin{eqnarray}
  ...
  \cr &=& H(\textbf{a}L + x-2 \textbf{a}R, x2 \textbf{a}L + \textbf{a}R, \textbf{b}L + x2 \textbf{b}R, x-2 \textbf{b}L + \textbf{b}R, 
