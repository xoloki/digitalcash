...
\begin{eqnarray}
  P' &=& H(0n', x^2 \textbf{a}_{[n':]}, x^2 \textbf{b}_{[:n']}, 0n', x^2 <\textbf{a}_{[n':]}, \textbf{b}_{[:n']}>) * H(\textbf{a}_{[n':]}, \textbf{a}_{[:n']}, \textbf{b}_{[n':]}, \textbf{b}_{[:n']}, <\textbf{a}, \textbf{b}>) *
  H(x^{-2} \textbf{a}_{[:n']}, \textbf{0}^{n'}, \textbf{0}^{n'}, x^{-2} \textbf{b}_{[n':]}, x^{-2} <\textbf{a}_{[:n']}, \textbf{b}_{[n':]}>)\\
  \cr &=& H(\textbf{a}_{[n':]} + x^{-2} \textbf{a}_{[:n']}, x^2 \textbf{a}_{[n':]} + \textbf{a}_{[:n']}, \textbf{b}_{[n':]} + x^2 \textbf{b}_{[:n']}, x^{-2} \textbf{b}_{[n':]} + \textbf{b}_{[:n']}, 
  x2 \left<\textbf{a}_{[n':]}, \textbf{b}_{[:n']}\right> + \left<\textbf{a}, \textbf{b}\right> + x^{-2} \left<\textbf{a}_{[:n']}, \textbf{b}_{[n':]}\right>)
\end{eqnarray}
