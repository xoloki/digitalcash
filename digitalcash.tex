...
\begin{align}
  ...
  \cr = H(&\textbf{a}_{[n':]} + x^{-2} \textbf{a}_{[:n']}, x^2 \textbf{a}_{[n':]} + \textbf{a}_{[n':]},\nonumber\\
          &\textbf{b}_{[:n']} + x^2 \textbf{b}_{[n':]}, x^{-2} \textbf{b}_{[n':]} + \textbf{b}_{[:n']},\nonumber\\
          &x^2 \left<\textbf{a}_{[n':]}, \textbf{b}_{[:n']}\right> + \left<\textbf{a}, \textbf{b}\right> + x^{-2} \left<\textbf{a}_{[:n']}, \textbf{b}_{[n':]}\right>)
\end{align}

It's because we get the same thing when we expand $P'$:
\begin{align}
  P' = &H(\textbf{0}^{n'}, x^2 \textbf{a}_{[n':]}, x^2 \textbf{b}_{[:n']}, \textbf{0}^{n'}, x^2 \left<\textbf{a}_{[n':]}, \textbf{b}_{[:n']}\right>) \cdot \nonumber\\
       &H(\textbf{a}_{[n':]}, \textbf{a}_{[:n']}, \textbf{b}_{[n':]}, \textbf{b}_{[:n']}, \left<\textbf{a}, \textbf{b}\right>) \cdot \nonumber\\
       &H(x^{-2} \textbf{a}_{[:n']}, \textbf{0}^{n'}, \textbf{0}^{n'}, x^{-2} \textbf{b}_{[n':]}, x^{-2} \left<\textbf{a}_{[:n']}, \textbf{b}_{[n':]}\right>)\\
  \cr = H(&\textbf{a}_{[n':]} + x^{-2} \textbf{a}_{[:n']}, x^2 \textbf{a}_{[n':]} + \textbf{a}_{[:n']}, \nonumber\\
          &\textbf{b}_{[n':]} + x^2 \textbf{b}_{[:n']}, x^{-2} \textbf{b}_{[n':]} + \textbf{b}_{[:n']}, \nonumber\\
          &x^2 \left<\textbf{a}_{[n':]}, \textbf{b}_{[:n']}\right> + \left<\textbf{a}, \textbf{b}\right> + x^{-2} \left<\textbf{a}_{[:n']}, \textbf{b}_{[n':]}\right>)
\end{align}
